...
namespace SDT
{
	...
	private:
		...
		struct
		{
			float* fMouseHeadingXScale{ nullptr };
			float* fMouseHeadingSensitivity{ nullptr };
			float* fPCDialogueLookStart{ nullptr };
			float* fMapMoveKeyboardSpeed{ nullptr };
			float* fAutoVanityIncrement{ nullptr };
			float* fPCDialogueLookSpeed{ nullptr };
			float* fFreeCameraRunSpeed{ nullptr };
			float* fFreeCameraTranslationSpeed{ nullptr };
		} m_gv;
